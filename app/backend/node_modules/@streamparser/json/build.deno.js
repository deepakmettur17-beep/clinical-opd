...
function copyReadme(dest) {
  writeFileSync(
    ...
    readFileSync("./README.md").toString()
      .replace(
        /import \{ JSONparserÂ \} from '@streamparser\/json';/gm,
        "import JSONparser from 'https://deno.land/x/streamparser_json@v0.0.3/jsonparser.ts';/",
      )
      .replace(
        /import { TokenizerÂ } from '@streamparser\/json';/gm,
      ...
      .replace(
        ...
        "import TokenParserÂ from 'https://deno.land/x/streamparser_json@v0.0.3/tokenparser.ts';/",
      ),
  );
}
