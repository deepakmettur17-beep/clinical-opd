...
describe('VersionedStruct', function() {
  describe('decode', function() {
    it('should get version from number type', function() {
      ...
      stream = new DecodeStream(Buffer.from('\x01\x0adevon ðŸ‘\x15\x00', 'utf8'));
      assert.deepEqual(struct.decode(stream), {
        version: 1,
        name: 'devon ðŸ‘',
        age: 21,
    ...
    it('should support common header block', function() {
      ...
      stream = new DecodeStream(Buffer.from('\x01\x15\x01\x0adevon ðŸ‘\x00', 'utf8'));
      assert.deepEqual(struct.decode(stream), {
        version: 1,
        age: 21,
        alive: 1,
    ...
    it('should support parent version key', function() {
      ...
      stream = new DecodeStream(Buffer.from('\x0adevon ðŸ‘\x15\x00', 'utf8'));
  ...
  describe('encode', function() {
    it('should encode objects to buffers', function() {
      ...
      assert.deepEqual(buf2,  Buffer.from('\x01\x0adevon ðŸ‘\x15\x00', 'utf8'));
    });
    ...
    it('should support common header block', function() {
      ...
      assert.deepEqual(buf2, Buffer.from('\x01\x15\x01\x0adevon ðŸ‘\x00', 'utf8'));
    });
